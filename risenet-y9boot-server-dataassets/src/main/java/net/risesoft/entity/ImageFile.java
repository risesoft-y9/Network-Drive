...
@NoArgsConstructor
@Entity
@Table(name = "Y9_DATAASSETS_IMAGE_FILE")
@org.hibernate.annotations.Table(comment = "照片类文件表", appliesTo = "Y9_DATAASSETS_IMAGE_FILE")
public class ImageFile implements Serializable {
    ...
    @Comment("组号")
    private String groupNumber;// 本件电子资产所属的组在“机构或问题代码”下排列的顺序号。

    @Column(name = "GROUP_TITLE", length = 600)
    @Comment("组题名")
    private String groupTitle;// 揭示本组电子资产共同反映的主要内容

    @Column(name = "PHOTOGRAPHER", length = 100)
    @Comment("摄影者")
    private String photographer;// 本件电子资产的拍摄者。应著录摄影者姓名及其工作单位名称，姓名与单位名称之间用“，"隔开。多个摄影者信息之间用“;”隔开。摄影者无法考证时以“□□□”代替。

    @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @Temporal(TemporalType.TIME)
    @Column(name = "PHOTOGRAPHY_TIME", length = 19)
    @Comment("摄影时间")
    private Date photographyTime;// 本件电子资产的拍摄时间。采用GB/T7408-2005中5.4.1 条的格式，例如“2021-02-24T10:23:14”
    ...
    @Comment("地点")
    private String place;// 本件电子资产的拍摄地点。

    @Column(name = "FIGURE", length = 600)
    @Comment("人物")
    private String figure;// 本件电子资产记录的主要人物信息著录人物的姓名、职务及其在照片中所处的位置，多个人物描述信息之间用”;”隔开。

    @Column(name = "BACKDROP", length = 200)
    @Comment("背景")
    private String backdrop;// 本件电子资产记录的具有检索或参照作用的实物背景信息，如建筑物、纪念碑、文 物等。

    @Column(name = "LOCATE_INFORMATION", length = 1200)
    @Comment("定位信息")
    private String locateInformation;// 本件电子资产拍摄地点的一组全球定位信息。包括全球定位系统版本，纬度基准，纬度，经度基准，经度，海拔基准，海拔，方向基准，镜头方向
