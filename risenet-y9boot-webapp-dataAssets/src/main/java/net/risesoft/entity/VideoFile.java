...
@NoArgsConstructor
@Entity
@Table(name = "Y9_DATAASSETS_VIDEO_FILE")
@org.hibernate.annotations.Table(comment = "录像类文件表", appliesTo = "Y9_DATAASSETS_VIDEO_FILE")
public class VideoFile implements Serializable {
    ...
    @Comment("捕获设备感光器")
    private String captureDeviceSensor;// 创建并形成本件电子资产的设备感光器的类型和参数 Not defined,One-chip color area sensor，Two-chip color
