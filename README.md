...
<img src="https://img.shields.io/badge/total%20lines-67.7k-blue.svg">
</p>
...
网络硬盘支持对文件进行标签管理，支持对文件进行标签添加、删除、修改、查询、搜索等功能。
用户为文件添加系统标签，也可以自定义标签，对文件进行标签化管理。
管理员可以增加、删除、修改系统标签和查看标签日志。
...
| 12       | 新建文件夹                  | 支持在线新建文件夹                                                         |
| 13       | 上传文件                   | 支持在线选择或拖拽上传文件，我的文件列表支持大文件快传、断点续传                                  |
| 14       | 下载文件                   | 支持在线下载文件                                                          |
| 15       | 分享文件                   | 支持将文件分享给其他人                                                       |   
| 16       | 删除文件                   | 支持在线删除文件                                                          |
...
| 20       | 直链下载                   | 支持以直链分享的方式下载文件，在我的文件列表中，选择文件生成直链并复制，在浏览器中访问链接，无需登录，下载时，需输入下载码下载文件 |
| 21       | 直链分享                   | 列表显示用户直链分享的记录，可复制直链分享链接和取消分享链接                                    |                                                   
| 21       | 文件搜索                   | 支持在文件列表中进行搜索，支持模糊搜索、全文搜索、日期范围搜索、文件类型搜索、文件大小搜索、文件标签搜索等             |
| 22       | 文件分享                   | 支持将文件分享给其他人                                                       |
| 23       | 文件标签管理                 | 支持对文件进行标签管理，支持对文件进行标签添加、删除、修改、查询、搜索等功能                            |
| 24       | 标签字典管理                 | 支持对标签进行字典管理，支持对标签进行添加、删除、修改、查询、搜索等功能                              |
