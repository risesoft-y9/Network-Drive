...
@Slf4j
@RestController
@RequestMapping(value = "/vue/metadataField", produces = MediaType.APPLICATION_JSON_VALUE)
public class MetadataFieldCofigController {

    private final JdbcTemplate jdbcTemplate4Tenant;

    private final MetadataFieldService metadataFieldService;

    public MetadataFieldCofigController(@Qualifier("jdbcTemplate4Tenant") JdbcTemplate jdbcTemplate4Tenant,
     ...
     */
    @GetMapping(value = "/getMetadataFieldList")
    public Y9Result<List<MetadataField>> getMetadataFieldList(@RequestParam String tableId) {
        List<MetadataField> map = metadataFieldService.listByTableId(tableId);
