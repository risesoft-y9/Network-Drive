...
public class ArchiveDetection {
    ...
    public ArchiveDetection(PersonApi personApi, Y9FileStoreService y9FileStoreService,
        ArchivesFileService archivesFileService, MetadataConfigService metadataConfigService,
        ...
        ArchiveDetection.archivesFileService = archivesFileService;
     ...
     * @param archives
     */
    public static void checkArchivesFile(String testingInfoId, Archives archives) {
        String tenantId = Y9LoginUserHolder.getTenantId();
        List<ArchivesFile> fileList = archivesFileService.findByArchivesId(archives.getArchivesId());
        if (null != fileList && fileList.size() > 0) {
            // TODO 验证档案文件上传人是否存在
            for (ArchivesFile file : fileList) {
     ...
     * @return
     */
    public static void checkDataTable(String testingInfoId, Archives archives) {
        List<Map<String, Object>> list_map = EntityOrTableUtils.getTableFieldList(Archives.class, "");
     ...
     */
    public static void checkRequiredMetadata(String testingInfoId, Archives archives) {
