    ...
    <el-dropdown :hide-on-click="true" class="user-el-dropdown" @command="onMenuClick">
        <div class="name" @click="(e) => e.preventDefault()">
            ...
            <div v-show="settingStore.getWindowWidth > 425">
                ...
                <span>{{ initInfo && initInfo.department && initInfo.department.name }}</span>
            </div>
        ...
        <template #dropdown>
            <el-dropdown-menu>
                ...
                <el-dropdown-item command="signIn">
                    <div class="el-dropdown-item"> <i class="ri-calendar-check-line"></i>{{ $t('已签到') }} </div>
                </el-dropdown-item>
                <el-dropdown-item command="signOut">
                    <div class="el-dropdown-item"> <i class="ri-bookmark-line"></i>{{ $t('已签退') }} </div>
                </el-dropdown-item>
