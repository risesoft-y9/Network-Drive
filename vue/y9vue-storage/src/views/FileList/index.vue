        ...
        <div class="toolbar">
            <div class="toolbar-left">
                ...
                <el-button
                    ...
                    v-on:click="bigUploaderFile"
                    plain
                >
                    <i class="ri-upload-cloud-2-line"></i>{{ $t('大文件上传') }}
                </el-button>
                        ...
                        <el-button
                            ...
                            >
                             <el-tooltip
                                        ...
                                        :content="$t('取消')"
                                        placement="top-start"
                                    ><i class="ri-close-line"></i></el-tooltip></el-button>
                    </el-form-item>
                    <el-row v-else @mouseenter="titleHover(row.id)" @mouseleave="titleLeave(row.id)">
                        ...
                        <el-col :span="7">
                            <div v-if="optButtonShow == row.id" class="optButtonCss" >
                                ...
                                <el-tooltip
                                    v-if="row.fileType == 0 && parentId !== 'shared'"
                                    class="box-item"
                                    effect="light"
                                    :content="$t('加密')"
                                    placement="top-start"
...
<script lang="ts" setup>
    import { ref, defineProps, onMounted, watch, computed, reactive, toRefs, nextTick, inject ,h,resolveComponent} from 'vue';
    ...
    const data = reactive({
        ...
        y9TableConfig: {
            ...
            columns: [
                ...
                { title: computed(() => t('日期')), key: 'time', width: '200',sortable: true, slot: 'time', headerSlot: 'fileDate' }
            ],
            tableData: []
        },
        dialogConfig: {
    ...
    const notCurrentSelectedOwner = computed(() => {
        let owner = true;
