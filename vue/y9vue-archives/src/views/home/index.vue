<template>
    <div class="y9-divider">
        <el-divider content-position="left">{{ $t('容器测试') }}</el-divider>
    </div>
                ...
                <el-form :model="form" label-width="120px">
                    ...
                    <el-form-item>
                        <el-button :size="fontSizeObj.buttonSize"
                                   :style="{ fontSize: fontSizeObj.baseFontSize }" style="background-color: var(--el-color-primary);color: #fff;">申请</el-button>
                        <el-button :size="fontSizeObj.buttonSize"
    ...
    <el-row :gutter="20">
                ...
                <div class="y9-table">
                    <el-table :data="tableData" style="width: 100%">
                        ...
                        <el-table-column fixed="right" align="center" label="操作" width="200">
                            <template #default>
                                <el-button :size="fontSizeObj.buttonSize"
                                           :style="{ fontSize: fontSizeObj.baseFontSize }" type="text" size="small">详细内容</el-button>
                                <el-button :size="fontSizeObj.buttonSize"
                                           :style="{ fontSize: fontSizeObj.baseFontSize }" type="text" size="small">编辑</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </div>
        ...
        <el-col :span="4">
            ...
            >
                <el-button :size="fontSizeObj.buttonSize"
                           :style="{ fontSize: fontSizeObj.baseFontSize }" style="background-color: var(--el-color-primary);color: #fff;">主题色调</el-button>
                <br />
                <el-button :size="fontSizeObj.buttonSize"
                           :style="{ fontSize: fontSizeObj.baseFontSize }" type="success">成功色调</el-button>
                <br />
                <el-button :size="fontSizeObj.buttonSize"
                           :style="{ fontSize: fontSizeObj.baseFontSize }" type="warning">警告色调</el-button>
                <br />
                <el-button :size="fontSizeObj.buttonSize"
                           :style="{ fontSize: fontSizeObj.baseFontSize }" type="danger">错误色调</el-button>
                <br />
                <el-button :size="fontSizeObj.buttonSize"
                           :style="{ fontSize: fontSizeObj.baseFontSize }" type="info">提示色调</el-button>
            </div>
        </el-col>
    </el-row>
</template>
