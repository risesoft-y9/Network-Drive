...
import Folder from "@/assets/fileType/large/Folder.png";
    ...
    state: () => {
        return {
            ...
            initSelectTreeSetting: {
                ...
                itemInterfaceCallBack: (data) => {//二级接口数据回调函数

                    return data;
                },
                topLevelInterfaceCallBack: (data) => {//一级级接口数据回调函数
