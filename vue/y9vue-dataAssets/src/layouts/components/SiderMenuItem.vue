 ...
 * @LastEditTime: 2024-10-10 09:45:12
 * @LastEditors: yihong yihong@risesoft.net
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: /sz- team-frontend-9.6.x/y9vue-dataAssets/src/layouts/components/SiderMenuItem.vue
-->
<template>
    <template v-if="!item.hidden">
        <template v-if="item.children && Array.isArray(item.children) && hasChildRoute(item.children)">
            <el-sub-menu :index="item.path" class="y9-el-sub-menu" :hide-timeout="3000000">
                <template #title>
