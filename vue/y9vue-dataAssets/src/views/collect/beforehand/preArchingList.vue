            ...
            <el-dropdown-menu>
              ...
              <el-dropdown-item >
                    <span
                        :size="fontSizeObj.buttonSize"
                        :style="{ fontSize: fontSizeObj.baseFontSize }"
                        @click="buildNoAndPlaceOnFile"
                    ><i class="ri-folder-received-line"></i>{{ $t('生成档号并归档') }}</span>
              </el-dropdown-item>
              <el-dropdown-item >
                    <span
                        :size="fontSizeObj.buttonSize"
...
import {deleteData, getArchivesList, saveFormData,createArchivesNo} from '@/api/dataAssets/dataAssets';
