<template>
    ...
    >
        ...
        <template #opt_button="{ row, column, index }">
            ...
            <span v-if="row.feedback == null || row.feedback == ''" @click="editData(row)">
                <i class="ri-edit-line" style="margin-left: 10px;"></i>编辑
            </span>
    ...
    const state = reactive({
        ...
        tableConfig: {
            columns: [
                ...
                { title: computed(() => t('处理结果')), key: 'feedback' },
